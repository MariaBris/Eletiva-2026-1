<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try{
          ...
          $mensagem = "<p>Erro: ".$e->getMessage()."</p>";
        }
    }
    try{
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" id="especie" name="especie" required="">
                    ...
                    <option value="Hamsters" <?= $resultado['especie'] == 'Hamsters' ? 'selected' : ''?>>Hamsters
                    </option>
                </select>
            </div>
            <div class="col-md-3">
        ...
        <div class="row g-3 mb-3 align-items-center">
            <div class="col-md-3">
                ...
                <div class="form-check form-check-inline mt-1">
                    <input type="radio" id="femea" name="sexo" value="F" class="form-check-input"
                        <?= $resultado['sexo'] == 'F' ? 'checked' : '' ?> required="">
                    <label for="femea" class="form-check-label">Fêmea</label>
                </div>
                <div class="form-check form-check-inline mt-1">
                    <input type="radio" id="macho" name="sexo" value="M" class="form-check-input"
                        <?= $resultado['sexo'] == 'M' ? 'checked' : '' ?> required="">
            ...
            <div class="col-md-3">
                ...
                <div class="form-check form-check-inline mt-1">
                    <input type="radio" id="castrado_sim" name="castrado" value="1" class="form-check-input"
                        <?= $resultado['castrado'] == '1' ? 'checked' : '' ?> required="">
                    <label for="castrado_sim" class="form-check-label">Sim</label>
                </div>
                <div class="form-check form-check-inline mt-1">
                    <input type="radio" id="castrado_nao" name="castrado" value="0" class="form-check-input"
                        <?= $resultado['castrado'] == '0' ? 'checked' : '' ?> required="">
